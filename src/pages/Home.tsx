...
import { BookOpen, Calculator, Clock, Github } from 'lucide-react';
  ...
  const modules = [
    {
      ...
      name: 'Modulo A: Conceptos',
      icon: <BookOpen className="w-5 h-5" />,
      description: 'Fundamentos teoricos'
    },
    {
      id: 'generator' as const,
      name: 'Modulo B: Generador',
      icon: <Calculator className="w-5 h-5" />,
      description: 'Variables aleatorias'
    },
    {
      id: 'simulation' as const,
      name: 'Modulo C: Simulacion',
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Entorno Interactivo de Simulacion Estadistica</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Basado en metodologia Coss Bu</span>
              <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-600">
              <p>Herramienta educativa para simulacion estadistica y analisis de sistemas estocasticos.</p>
              <p className="mt-1">Implementa metodos de generacion de variables aleatorias y simulacion de eventos discretos.</p>
            </div>
